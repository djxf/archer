...
public class StatusBarUtils {
    ...
    public static void setDeepColorStatusBar(Window window) {
        if (OSHelper.isMIUI()) {
            ...
            LogUtils.d(TAG, TAG + "->not supported device");
        }
     ...
     */
    private static void FlymeStatusBarLightMode(Window window, boolean isDeepColor) {
        if (window != null) {
            try {
     ...
     * @return boolean 成功执行返回true
     */
    private static void MIUIStatusBarLightMode(Window window, boolean isDeepColor) {
        if (window != null) {
    ...
    private static void AndroidMStatusBarLightMode(Window window) {
